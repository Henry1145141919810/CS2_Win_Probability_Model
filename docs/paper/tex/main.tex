...
TCN reaches AUC $0.8443$ (95\,\% CI $0.825$--$0.862$) and the Transformer $0.8448$ ($0.826$--$0.863$)
--- landing exactly on the classical EFB2 out-of-time number ($0.8450$, logistic) with fully
...
The smoking gun of Sect.~\ref{sec:holdout} --- a calibration intercept of $-0.36$ and ECE $0.071$ ---
appears \emph{only} in the broken build. Both coverage-complete variants sit at the benign near-zero
...
exactly as the count confound of Sect.~\ref{sec:firepower} predicts ($r = 0.987$ with the player count
--- the feature mostly counts players, so the ratings inside the sum are almost immaterial). The
