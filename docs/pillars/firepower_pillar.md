...
**Benchmark (same 220 demos / 5-fold OOF / B=500; full numbers in `docs/studies/results_checkpoint.md` and
`docs/methodology/methodology.md` "Pillar 3 v1→v2"):**
...
**The only remaining firepower work: the 2026 HLTV scrape** — see `docs/project/TODO_leu_2026_scrape.md`.
