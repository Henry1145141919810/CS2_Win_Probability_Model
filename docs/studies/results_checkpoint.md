...
**UPDATE 2026-07-25 (all 3 variants done):** Leu delivered both 2025 (lagged) and 2026 (same-year) stats,
82/82 each. Ran all three holdout variants. **Firepower beats the demo-only EB2 under NONE of them** —
broken (0.8236), leak-free lagged (0.8423), or leaky same-era 2026 oracle (0.8450) — all still below EB2
(0.8474 logreg), on every model. Calibration is fully repaired by coverage alone (intercept −0.36 → ~0).
Same-year ≈ lagged (count confound). **Verdict settled: ship EB2, no firepower.** See
[notes_lagged_holdout.md](../pillars/notes_lagged_holdout.md) + Fig. F6.

Snapshot of every pillar, model, feature set, test/metric, and the honest verdict on what
works. Companion to `docs/methodology/methodology.md` (full protocol + derivations).

**Planning docs:** [roadmap.md](../project/roadmap.md) (milestones + tracker for Henry & Leu) ·
[submission_requirements.md](../project/submission_requirements.md) (venue rules, deadlines, links).
