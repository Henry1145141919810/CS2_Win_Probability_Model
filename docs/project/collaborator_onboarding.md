...
arXiv + MLSA 2027. Full rationale in [`docs/methodology/methodology.md`](../methodology/methodology.md).
...
docs/methodology/methodology.md, docs/methodology/sampling.md   # the "why" docs
```
...
- `process.md` and `preprocess.md` (the running dev log / planning) are **local/git-ignored** —
  this file + `docs/methodology/methodology.md` are the shared sources of truth.
...
Questions → ping Henry, or read `docs/methodology/methodology.md`.
