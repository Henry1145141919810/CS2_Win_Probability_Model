...
[notes_lagged_holdout.md](../pillars/notes_lagged_holdout.md) (firepower results), [paper/CHANGELOG.md](../../paper/CHANGELOG.md).
...
[notes_lagged_holdout.md](../pillars/notes_lagged_holdout.md)).
...
See [notes_firepower_v3.md](../pillars/notes_firepower_v3.md) for full analysis.
...
Two studies planned in detail in [plan_beyond_economy.md](../studies/plan_beyond_economy.md). Both strengthen the
